    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    {filteredPatients.length > 0 ? (
                      filteredPatients.slice(0, 5).map((patient) => (
                        <button
                          ...
                          className="w-full px-4 py-3 text-left hover:bg-gray-50 dark:hover:bg-gray-700 border-b border-gray-100 dark:border-gray-600 last:border-0"
                        >
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-500 dark:text-gray-400">{patient.id} • {patient.phone}</p>
                            </div>
                          </div>
                        </button>
                      ))
                    ) : (
                      <div className="px-4 py-3 text-gray-500 dark:text-gray-400">কোনো রোগী পাওয়া যায়নি</div>
                    )}
                  </div>
                )}
          ...
          <Card>
            ...
            <CardContent>
              <textarea
                ...
                rows={3}
                className={`w-full p-3 border rounded-md resize-none text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 placeholder:text-gray-500 dark:placeholder:text-gray-400 ${errors.diagnosis ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'}`}
              />
                  ...
                  {prescriptionData.medicines.map((medicine, index) => (
                    <div key={index} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                      <div className="flex items-start justify-between mb-4">
                        <h4 className="font-medium text-gray-900 dark:text-gray-100">ওষুধ #{index + 1}</h4>
                        <Button
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>প্রেসক্রিপশন সারসংক্ষেপ</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">মোট ওষুধ:</span>
